  ...
  if (!accessToken) {
    ...
    if (!code) {
      window.location.href =
        "https://secure.meetup.com/oauth2/authorize?client_id=7e414fuundrb6s3opmhspmud52&response_type=code&redirect_uri=https://jessmcdonald.github.io/meetup/";
      return null;
    }
...
async function getOrRenewAccessToken(type, key) {
  ...
  if (type === "get") {
    ...
    url =
      "https://riqfexrptk.execute-api.eu-central-1.amazonaws.com/dev/api/token/" +
      key;
  } else if (type === "renew") {
    //lambda endpoint to refresh token by refresh_token
    url =
      "https://riqfexrptk.execute-api.eu-central-1.amazonaws.com/dev/api/refresh/" +
      key;
  }
